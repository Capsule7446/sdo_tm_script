...
(function (React, ReactDOM) {
  ...
  */
  ...
  const divWithClassName = (className) => /* @__PURE__ */ React__namespace.forwardRef((p2, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    ...p2,
    ref,
  ...
  const Button = /* @__PURE__ */ React__namespace.forwardRef(({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
      ...
      ref,
      disabled,
      className: classNames(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && disabled && "disabled")
    });
  });
  ...
  const Context = /* @__PURE__ */ React.createContext(canUseDOM ? window : void 0);
  Context.Provider;
  function useWindow() {
  ...
  function useWaitForDOMRef(ref, onResolved) {
    ...
    const [resolvedRef, setRef] = React.useState(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
    if (!resolvedRef) {
  ...
  const Modal = /* @__PURE__ */ React__namespace.forwardRef(({
    ...
    const renderBackdrop = React.useCallback((backdropProps) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      ...backdropProps,
  ...
  const Table = /* @__PURE__ */ React__namespace.forwardRef(({
    bsPrefix,
    className,
    striped,
    bordered,
    ...
    const classes = classNames(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  ...
  function App() {
    ...
    const getData = (page) => {
      axios$1.get(`https://chdact2.web.sdo.com/project/ChdGrade/order.asp?page=${page}`).then((response) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Modal$1,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Header, { closeButton: true, onClick: hide, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Title, { children: "等級補完" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Body, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table$1, { striped: true, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "#" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "道具名稱" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "道具編碼" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: nData.map((value, index) => {
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: index + 1 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: value.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: value.token.map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  k2,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1.Footer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "secondary", onClick: hide, children: "Close" }) })
        ]
      }
    ) });
  }
